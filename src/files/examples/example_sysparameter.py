...
## Gets sensor system parameter information

sysparam = f.getSystemParameters()
#print('Sensor system parameter: ' + str(f.getTemplateCount()) +'/'+ str(f.getStorageCapacity()))
print('Sensor system parameter: {0}'.format(sysparam))
